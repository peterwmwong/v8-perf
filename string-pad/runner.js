...
const VARIANTS = {
  'padStart-maxLength-string': 'padStart(maxLength, string)',
  'padEnd-maxLength-string': 'padEnd(maxLength, string)',
  'padStart-maxLength': 'padStart(maxLength)',
  'padEnd-maxLength': 'padEnd(maxLength)'
}
