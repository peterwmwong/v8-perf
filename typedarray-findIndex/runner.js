...
const VARIANTS = {
  Int8Array: 'Int8Array.p.find(f)',
  Uint8Array: 'Uint8Array.p.find(f)',
  Uint8ClampedArray: 'Uint8ClampedArray.p.find(f)',
  Int16Array: 'Int16Array.p.find(f)',
  Uint16Array: 'Uint16Array.p.find(f)',
  Int32Array: 'Int32Array.p.find(f)',
  Uint32Array: 'Uint32Array.p.find(f)',
  Float32Array: 'Float32Array.p.find(f)',
  Float64Array: 'Float64Array.p.find(f)',
};
...
drawBarChart(results.filter(r => r.variant.includes('no-offset')));
drawBarChart(results.filter(r => !r.variant.includes('no-offset')));
